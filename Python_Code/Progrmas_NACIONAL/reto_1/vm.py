#Usa puro el idar normal con una correcion de 2 puntos 
        ...
        while running:
            try:
                ...
                if obj_lidar.dist_left > 700 or obj_lidar.dist_right > 700:
                    ...
                    direccion = avanzar_detection_lidar(70,0)
                    time.sleep(1)

                    if direccion == izq:
                        vuelta_grados(izq,70,88)
                        centrar_vehiculo()
                        avanzar_recto_grados(70,1600,90)
                        time.sleep(0.1)
                        angulo_correcion = dos_puntos_izquierda(70,500,90)
                        ...
                        while v < 11:
                            ...
                            vuelta_grados(izq,70,88)
                            centrar_vehiculo()
                            avanzar_recto_grados(70,300,90)
                            reset_gyro(0)
                            angulo_correcion = dos_puntos_izquierda(70,500,90)
                            reset_gyro(angulo_correcion)
                            print_gyro()
                            time.sleep(0.1)
                            v = v + 1
                        avanzar_recto_grados(70,300,0)
                    
                    if direccion == der:
                        vuelta_grados(der,70,88)
                        centrar_vehiculo()
                        avanzar_recto_grados(70,1600,-90)
                        angulo_correcion = dos_puntos_derecha(70,720,-90)
                        reset_gyro(angulo_correcion)
                        time.sleep(0.1)
                        while v < 11:
                            avanzar_detection_derecho_lidar(70,0)
                            vuelta_grados(der,70,88)
                            centrar_vehiculo()
                            avanzar_recto_grados(70,1200,-90)
                            reset_gyro(0)
                            angulo_correcion = dos_puntos_derecha(70,720,-90)
                            reset_gyro(angulo_correcion)
                            time.sleep(0.1)
                    ...
                    if direccion == izq:
                        vuelta_grados(izq,70,88)
                        centrar_vehiculo()
                        avanzar_recto_grados(70,600,90)
                        angulo_correcion = dos_puntos_izquierda(70,500,90)
                        reset_gyro(angulo_correcion)
                        time.sleep(0.1)
                        while v < 11:
                    ...
                    if direccion == der:
                        ...
                        centrar_vehiculo()
                        avanzar_recto_grados(70,600,-90)
                        angulo_correcion = dos_puntos_derecha(70,500,-90)
                        reset_gyro(angulo_correcion)
                        time.sleep(0.1)
                        while v < 11:
                            avanzar_detection_derecho_lidar(70,0)
